                ...
                <div className="m-l-25 m-r--38 m-lr-0-xl">
                    ...
                    <table className="table-shopping-cart">
                      <tbody>
                        ...
                        <tr className="table_row">
                          <td className="column-1">
                            <div className="how-itemcart1">
                              <img src="src/assets/images/item-cart-04.jpg" alt="IMG" />
                            </div>
                          </td>
                        ...
                        <tr className="table_row">
                          <td className="column-1">
                            <div className="how-itemcart1">
                              <img src="src/assets/images/item-cart-05.jpg" alt="IMG" />
                            </div>
                          </td>
                  ...
                  <div className="flex-w flex-sb-m bor15 p-t-18 p-b-15 p-lr-40 p-lr-15-sm">
                    <div className="flex-w flex-m m-r-20 m-tb-5">
                      ...
                      <div className="flex-c-m stext-101 cl2 size-118 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer m-tb-5">Apply coupon</div>
                    </div>
                    <div className="flex-c-m stext-101 cl2 size-119 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer m-tb-10">Update Cart</div>
                  </div>
                </div>
              </div>
                ...
                <div className="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
                  ...
                  <div className="flex-w flex-t bor12 p-t-15 p-b-30">
                    ...
                    <div className="size-209 p-r-18 p-r-0-sm w-full-ssm">
                      <p className="stext-111 cl6 p-t-2">There are no shipping methods available. Please double check your address, or contact us if you need any help.</p>
                      <div className="p-t-15">
                        ...
                        <div className="flex-w">
                          <div className="flex-c-m stext-101 cl2 size-115 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer">Update Totals</div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <button className="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer">Proceed to Checkout</button>
                </div>
              </div>
            </div>
          </div>
